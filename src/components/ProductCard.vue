...
<template>
  ...
  >
    <!-- ── Banners ── -->
    <div v-if="isFavoriteTeam" class="top-banner banner-heart">❤️ Seu time</div>
...
.top-banner { font-size: 11px; font-weight: 700; padding: 5px 12px; letter-spacing: 0.5px; text-align: center; }
...
.club-label { font-size: 11px; font-weight: 700; color: #60a5fa; text-transform: uppercase; letter-spacing: 0.8px; margin: 0 0 4px; }
.product-name { font-size: 14px; font-weight: 600; color: #f1f5f9; margin: 0 0 3px; line-height: 1.35; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
.season-label { font-size: 12px; color: #64748b; margin: 0 0 10px; }
.price-row { margin-bottom: 10px; }
.price { font-size: 18px; font-weight: 800; color: #34d399; }

.sizes-row { display: flex; flex-wrap: wrap; gap: 5px; margin-bottom: 12px; }
.size-chip { border: 1px solid #475569; border-radius: 5px; padding: 2px 7px; font-size: 11px; font-weight: 600; color: #cbd5e1; }
...
.size-more { font-size: 11px; color: #64748b; align-self: center; }

.actions { margin-top: auto; display: flex; gap: 6px; }
.details-btn { flex: 1; padding: 9px 0; background: #2563eb; color: #fff; border: none; border-radius: 9px; font-size: 13px; font-weight: 600; cursor: pointer; transition: background 0.15s; }
.details-btn:hover:not(.btn-oos) { background: #1d4ed8; }
.details-btn.btn-oos { background: #374151; color: #6b7280; cursor: default; }

.whatsapp-btn { display: flex; align-items: center; justify-content: center; gap: 5px; padding: 9px 10px; background: #16a34a; color: #fff; border: none; border-radius: 9px; font-size: 13px; font-weight: 600; text-decoration: none; cursor: pointer; transition: background 0.15s; white-space: nowrap; }
.whatsapp-btn:hover { background: #15803d; }
.wa-icon { width: 14px; height: 14px; flex-shrink: 0; }

.share-btn { width: 36px; flex-shrink: 0; background: #0f172a; border: 1px solid #334155; color: #94a3b8; border-radius: 9px; font-size: 14px; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.15s; }
